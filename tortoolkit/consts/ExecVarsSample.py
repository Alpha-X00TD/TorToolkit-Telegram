try:
    ...
    class ExecVars:
        ...
        API_HASH = "42e520063120b19142822fcb7a043b4d"
        API_ID = 3409279
        BOT_TOKEN = "1782070147:AAGSlogAIij91lM0RtEzOrQ_sbUGlucxa5U"
        BASE_URL_OF_BOT = "http://t.me/Leech21bot"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [1557573671,1001328551758]
        OWNER_ID = 0
